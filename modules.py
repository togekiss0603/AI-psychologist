...
#             user="neo4j",
#             password="123456")
graph = Graph("http:localhost:7474", auth=("neo4j","A13003811286"))
...
def semantic_parser(text):
    ...
    last_slot_values = load_user_dialogue_context("qzy")["slot_values"]
