...
class MedicalNerModel(object):
    ...
    def __init__(self):
        ...
        self.word2id,_,self.id2tag = pickle.load(
                open("D:/data_model/bilstm/checkpoint/word_tag_id.pkl","rb")
            )
        self.model = BiLstmCrfModel(80,2410,200,128,24).build()
        self.model.load_weights('D:/data_model/bilstm/checkpoint/best_bilstm_crf_model.h5')

        self.nbd = NerBaseDict('D:/data_model/bilstm/checkpoint/diseases.json')
