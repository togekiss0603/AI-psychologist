...
class BertIntentModel(object):
    ...
    def __init__(self):
        ...
        self.dict_path = 'D:\chinese_bert_wwm_L-12_H-768_A-12/vocab.txt'
        self.config_path = 'D:\chinese_bert_wwm_L-12_H-768_A-12/bert_config.json'
        self.checkpoint_path = 'D:\chinese_bert_wwm_L-12_H-768_A-12/bert_model.ckpt'
        ...
        self.model.load_weights("D:\data_model\intent_recg_bert\model/best_model_weights")
